...
// using substr() pppp ="Appbsnle, bananas, kiwi";
...
console.log(word.replace("microsoftward!", "wschool")) //word ="please visit microsoftward! and microsoftward!"
console.log(word.replace(/microsoftward!/g, "wschool"));
